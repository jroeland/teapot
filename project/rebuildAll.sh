...
docker-compose run web python /home/docker/code/app/manage.py migrate
docker-compose run web python /home/docker/code/app/manage.py loaddata /home/docker/code/app/admin/fixtures/initial_data.json
...
docker-compose run web python /home/docker/code/app/manage.py loaddata /home/docker/code/app/discounts/fixtures/initial_data.json